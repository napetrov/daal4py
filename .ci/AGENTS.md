...
- **sklearn**: Multiple version compatibility (all versions beyond 1.0)
- **torch**: PyTorch integration and testing
...
**Linux** (from .ci/pipeline/build-and-test-lnx.yml):
```bash
...
- Set required environment variable (DALROOT)
